...
The specification is the artifact that matters: it gives the agent structured context to work within, and gives us a concrete contract to review before code is generated.
...
Where scenarios are best captured collaboratively with business stakeholders, [BDD](/methods-and-patterns/bdd) and Gherkin remain a good source of input for a spec.

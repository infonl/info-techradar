...
EU LLM routers offer what [OpenRouter](/platforms-and-operations/openrouter) offers (one API for many models, switching models without code changes), but operated by European companies with EU data residency by default. They are the router counterpart of the [European Sovereign Cloud](/platforms-and-operations/european-sovereign-cloud).
...
- **[Eden AI](https://www.edenai.co/)** (Lyon, France): unified API for LLMs plus OCR, speech, translation and vision models, GDPR-native with a standard data processing agreement.
